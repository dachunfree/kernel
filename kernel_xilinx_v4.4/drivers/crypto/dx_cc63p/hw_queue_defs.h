...
#define HW_DESC_SET_DIN_TYPE(pDesc, dmaMode, dinAdr, dinSize, axiId, axiNs)							\
	do {		                                                                                        		\
		...
		DX_CC_REG_FLD_SET(CRY_KERNEL, DSCRPTR_QUEUE0_WORD5, DIN_ADDR_HIGH, (pDesc)->word[5], (dinAdr>>MAX_SHIFGT)&UINT16_MAX );		\
...
#define HW_DESC_SET_DOUT_TYPE(pDesc, dmaMode, doutAdr, doutSize, axiId, axiNs)							\
	do {		                                                                                        		\
		...
		DX_CC_REG_FLD_SET(CRY_KERNEL, DSCRPTR_QUEUE0_WORD5, DOUT_ADDR_HIGH, (pDesc)->word[5], (doutAdr>>MAX_SHIFGT)&UINT16_MAX );		\
