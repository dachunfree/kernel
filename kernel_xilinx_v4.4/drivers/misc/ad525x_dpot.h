...
#define F_CMD_SHIFT		(1 << 10)	/* input shift register */

#define F_RDACS_RW_TOL	(F_RDACS_RW | F_CMD_EEP | F_CMD_TOL)
#define F_RDACS_RW_EEP	(F_RDACS_RW | F_CMD_EEP| F_CMD_SHIFT)
...
enum dpot_devid {
	...
	AD5122_ID = DPOT_CONF(F_RDACS_RW_EEP, BRDAC0|BRDAC1, 8, 52),
};
...
#define DPOT_ADDR_SHIFT		(0x1 << 10)

/*AD5122 -RADC-EEPROM-ADDR*/
#define AD5122_RADC0				0x10
#define AD5122_RADC1				0x11
#define AD5122_EEPROM0				0x70
#define AD5122_EEPROM1				0x71
#define AD5122_SHIFT0				0x20
#define AD5122_SHIFT1				0x21
#define AD5122_READ_EEPROM0			0x30
#define AD5122_READ_EEPROM1			0x31
